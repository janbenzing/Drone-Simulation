...
{	
	_pos_accept_rad = 0.5f;

	param_set(_p_accept_rad, &_pos_accept_rad);
}
...
bool SonarLandingCtrl::update_landing()
{
	...
	if (_ground_detected)
	{
		PX4_INFO("LANDING POSITION ACHIEVED");
		return true;
	}else{
		return false;
	}

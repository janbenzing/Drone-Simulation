...
STUDENT_REPO_NAME=dronecourse-student
STUDENT_REPO_URL=https://github.com/dronecourse-epfl/${STUDENT_REPO_NAME}.git
FIRMWARE_ROOT=$PWD
...
git add --all
DATE=$(date +"%Y-%m-%d %H:%M")
COMMIT_MESSAGE="Autogenerated code for students on ${DATE}"
